...
class TestModelEndpoint(TestDatabaseBase):
    ...
    def test_list_filters(self) -> None:
        ...
        model_endpoint = mlrun.common.schemas.ModelEndpoint(
            metadata={"name": "model-endpoint-1", "project": "project-1", "mode": mlrun.common.schemas.EndpointMode.REAL_TIME},
            spec={
                "function_name": "function-1",
                "function_tag": "latest",
                "_model_id": 2,
        ...
        different_name_model_endpoint = mlrun.common.schemas.ModelEndpoint(
            metadata={"name": "model-endpoint-2", "project": "project-1", "mode": mlrun.common.schemas.EndpointMode.BATCH,
        ...
        list_mep = self._db.list_model_endpoints(
            self._db_session,
            project=model_endpoint.metadata.project,
            modes=[mlrun.common.schemas.EndpointMode.REAL_TIME, mlrun.common.schemas.EndpointMode.BATCH],
        ).endpoints
        assert len(list_mep) == 2
